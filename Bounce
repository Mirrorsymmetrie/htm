...
Mirror.prototype.error = function (message) {
...
Mirror.prototype.set_viewport = function (x, y) {

    this.viewport.x = x;
    this.viewport.y = y;
};

Mirror.prototype.keydown = function (e) {
...
Mirror.prototype.keyup = function (e) {
...
Mirror.prototype.load_map = function (map) {
...
Mirror.prototype.get_tile = function (x, y) {

    return (this.current_map.data[y] && this.current_map.data[y][x]) ? this.current_map.data[y][x] : 0;
};

Mirror.prototype.draw_tile = function (x, y, tile, context) {
...
Mirror.prototype.draw_map = function (context, fore) {
...
Mirror.prototype.move_player = function () {
...
Mirror.prototype.update_player = function () {
...
Mirror.prototype.draw_player = function (context) {
